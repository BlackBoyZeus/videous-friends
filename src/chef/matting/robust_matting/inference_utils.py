...
from fractions import Fraction  # Added for frame_rate conversion
...
class VideoWriter:
    def __init__(self, path, frame_rate, bit_rate=1000000):
        # Convert frame_rate to Fraction if it's a float
        if isinstance(frame_rate, float):
            frame_rate = Fraction.from_float(frame_rate).limit_denominator(1000)
